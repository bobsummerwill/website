---
layout: post
title: "Bob’s Next Adventure"
date: "2017-10-18 14:49:58 -0700"
...
David was one of the first customers at the world's first Bitcoin ATM, right here in Vancouver in October 2013, and was heavily involved in Bitcoin for many years before that. His first Bitcoin trades were at 5 cents. in 2010 he sought out and acquired the domain name [Bitcoin.com](http://bitcoin.com/), later selling it for a substantial profit.
...
By 2015 I was living in Toronto and took advantage of their great crypto Meetup scene. Techno Crypto with [Jeff Coleman](https://www.linkedin.com/in/technocrypto/) at Decentral, Ethereum Toronto Meetup with [Paul Paschos](https://www.linkedin.com/in/paulpaschos/), DEC_TECH at the Mars Discovery Centre with [Anthony Di Iorio.](https://www.linkedin.com/in/anthonydiiorio1/)
...
I started [doublethink.co](https://doublethink.co/) and hired [Anthony Cros](https://www.linkedin.com/in/anthony-cros-3587b063/) to start working on [cpp-ethereum-cross](https://github.com/doublethinkco/cpp-ethereum-cross) while my days were full at TD Securities.

Later that year on my return to Vancouver, I was able to get hands-on with that project, seeking to get an Ethereum light client working on a Gear S2 smartwatch. That work morphed into helping out the cpp-ethereum project which morphed into a part-time job on Christian Reitwiessner's team, which then morphed into a full-time role. On we went through [Homestead](http://www.ethdocs.org/), major build system and DevOps work and the repository restoration of [cpp-ethereum-1.3.0 ("Homecoming")](https://github.com/bobsummerwill/cpp-ethereum/releases/tag/v1.3.0), the DAO fork, the [failed](https://www.reddit.com/r/ethereum/comments/5qp5pc/ethcore_blocked_cppethereum_permissive_relicensing/?st=j8uq42ns&sh=9b57abb6) Apache 2.0 [relicensing attempt](https://bobsummerwill.com/2016/07/12/ethereum-everywhere/) and on to the amazing [DEVCON2 conference](https://ethereumfoundation.org/devcon2/) in Shanghai.
...
Joe is one of the most inspirational and enlightened leaders who I have ever met, and ConsenSys is one of the most unique places that I have ever had the pleasure of working at. This is going to be a world-renowned company in the very near future. It is already getting there and can now hire the [cream](https://www.coindesk.com/ethereum-startup-consensys-hires-ibm-oracle-execs-sizeable-expansion-push/) of the [crop](https://www.coindesk.com/ethereum-startup-consensys-launches-50-million-blockchain-fund/).
...
So that's what I will be up to next. It should be a lot of fun. I wish all my former colleagues at ConsenSys and the EEA the best of luck for the future as we continue to build this new ecosystem together. As Joe recently said at [ETHWaterloo](https://ethwaterloo.com/), we are still in the "first minute", and have years of collaboration and building ahead of us. Our paths will cross many times again in the future.
