---
layout: post
title: "New Year.  New Role.  New Office."
date: "2018-01-05 05:14:56 -0800"
permalink: /2018/01/05/new-year-new-role-new-office/
---
...
My role at [Sweetbridge](https://www.sweetbridge.com) changed just before Christmas too. I started work for Sweetbridge on 23rd October as **Principal Developer**. When I was first talking to Sweetbridge, I was absolutely certain that I had to drop everything I was doing at ConsenSys and the EEA to go and [join this amazing project](https://bobsummerwill.com/2017/10/18/bobs-next-adventure/). What was not clear to me, though, was exactly what position at Sweetbridge would work best for me and for Sweetbridge.

There were two main options - joining the Sweetbridge Alliance side with [Mac McGary](https://www.linkedin.com/in/mac-mcgary-3792131/), or join the R&D/Product side with [Glenn Jones](https://www.linkedin.com/in/glenn-jones-8438a3/). I was a little hesitant to put myself in a position with the Alliance where I was ineffective (or indeed a liability) because of my complete lack of supply chain experience, despite having worked in a similar role at the Enterprise Ethereum Alliance for the previous year. Joining the product team looked like a much safer bet. I have been a software engineer for 20+ years, working on Ethereum for 2.5+ years, wanted to help build a real product, so my choice was made.

Only a week into my time at Sweetbridge though, I was off to [Cancun for DEVCON3](https://bobsummerwill.com/2017/10/30/i-am-with-my-tribe-at-devcon3/) (which I still owe the world a blog post about!) That trip had been scheduled for months, and is not something I would have missed for the world. I offered my services, despite being brand new to Sweetbridge, for media interviews, talking to potential partners, alliance building, etc. I do love all that kind of work.
...
Please do come join our [Rocket.Chat](https://chat.sweetbridge.com) and our [Telegram](https://t.me/sweetbridge). As well as my new physical work home, those are my new online homes. I am delighted to have the opportunity to work closer with [Melissa Gilmour](https://www.linkedin.com/in/melissagilmour/), [Jason English](https://www.linkedin.com/in/jasonenglish/) and [Ryan Charleston](https://www.linkedin.com/in/ryancharleston/) as part of my new role. Melissa has been focused on Events, Jason on Protocol Marketing and Ryan on Social Media. We will work together to tie all of these elements together in a more cohesive message and dynamic community. WATCH OUT WORLD!

So my new office is at [Frontier Foundry](https://www.frontierfoundry.co), who are the only company which I advise (see my [Conflict of Interests](https://bobsummerwill.com/conflict-of-interests-statement/) statement). I first met Boris in 2015, and I am delighted to be part of the Frontier adventure. In addition to the primary product which Frontier are developing, Frontier are acting as the catalyst for growing the blockchain ecosystem here in British Columbia, which is something very close to my heart, and which I am also actively participating in.

See [my schedule](https://bobsummerwill.com/schedule/) for 2017 and 2018 to get an idea of the number of Vancouver-focused events and meetups which I am attending. I am making a conscious effort to attend just about every Vancouver-based conference or event, all the BC Blockchain Forum and Blockchain for Product Developers meetings, and will be adding Blockchain @ UBC engagement onto the slate imminently.
